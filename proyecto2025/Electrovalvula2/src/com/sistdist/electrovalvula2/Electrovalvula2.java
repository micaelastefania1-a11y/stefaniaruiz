...
public class Electrovalvula2 {
    ...
    int id = 2; // identificador de la primera electrovalvula
        try {
            ...
            Logger.getLogger(Electrovalvula2.class.getName()).log(Level.SEVERE, null, ex);
        }
