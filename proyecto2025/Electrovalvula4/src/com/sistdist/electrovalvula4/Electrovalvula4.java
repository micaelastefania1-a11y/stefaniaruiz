...
public class Electrovalvula4 {
    ...
    int id = 4; // identificador de la primera electrovalvula
        try {
            ...
            Logger.getLogger(Electrovalvula4.class.getName()).log(Level.SEVERE, null, ex);
        }
